...
//        });
    ...
    */
    var lessons = [
    {
        img: 'images/lessons/abc.png',
        video: 'videos/abc.mp4'
    },
    {
        img: 'images/lessons/abc1.png',
        video: 'videos/abc1.mp4'
    },
    {
        img: 'images/lessons/a.png',
        video: 'videos/a.mp4'
    }
    ];
    $('#j_class').click(function() {
        $.ajax({
            type: 'POST',
            url: 'http://54.179.157.156'
        }).done(function(data) {
            var className = data.retData.class && data.retData.class[0];
            $('#j_class').find('h2').html(className);
        })
    });
